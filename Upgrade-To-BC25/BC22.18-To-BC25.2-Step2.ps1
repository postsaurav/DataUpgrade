...
Invoke-NAVApplicationDatabaseConversion -DatabaseServer localhost -DatabaseName BC22_To_BC25
...
Set-NAVServerConfiguration -ServerInstance BC252 -KeyName DatabaseName -KeyValue BC22_To_BC25
...
#Publish extensions
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC 25 - DE\Core Apps\Microsoft_System Application.app"
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC 25 - DE\Core Apps\Microsoft_Business Foundation.app"
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC 25 - DE\Core Apps\Microsoft_Base Application.app"
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC 25 - DE\Core Apps\Microsoft_Application.app"
...
Get-NAVDataUpgrade -ServerInstance BC252 -Progress
