...
Invoke-NAVApplicationDatabaseConversion -DatabaseServer localhost -DatabaseName BC19-To-BC25
...
Set-NAVServerConfiguration -ServerInstance BC252 -KeyName DatabaseName -KeyValue BC19-To-BC25
...
#Publish extensions
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC - IN\Core Apps\Microsoft_System Application.app"
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC - IN\Core Apps\Microsoft_Business Foundation.app"
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC - IN\Core Apps\Microsoft_Base Application.app"
Publish-NAVApp -ServerInstance BC252 -Path "E:\Upgrade To BC - IN\Core Apps\Microsoft_Application.app"
...
#Synchronize Apps
Sync-NAVApp -ServerInstance BC252 -Tenant default -Name "System Application" -Version 25.3.28755.29378
Sync-NAVApp -ServerInstance BC252 -Tenant default -Name "Business Foundation" -Version 25.3.28755.29378
Sync-NAVApp -ServerInstance BC252 -Tenant default -Name "Base Application" -Version 25.3.28755.29378
Sync-NAVApp -ServerInstance BC252 -Tenant default -Name "Application" -Version 25.3.28755.29378


#Upgrade data
Start-NAVAppDataUpgrade -ServerInstance BC252 -Name "System Application" -Version 25.3.28755.29378
Install-NAVApp -ServerInstance BC252 -Name "Business Foundation" -Version 25.3.28755.29378
Start-NAVAppDataUpgrade -ServerInstance BC252 -Name "Base Application" -Version 25.3.28755.29378
Start-NAVAppDataUpgrade -ServerInstance BC252 -Name "Application" -Version 25.3.28755.29378
...
Set-NAVApplication -ServerInstance BC252 -ApplicationVersion 25.3.28755.29378 -Force
