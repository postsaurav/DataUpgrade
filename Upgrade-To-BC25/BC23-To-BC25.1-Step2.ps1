...
Invoke-NAVApplicationDatabaseConversion -DatabaseServer localhost -DatabaseName BC23_To_BC25
...
Set-NAVServerConfiguration -ServerInstance BC250 -KeyName DatabaseName -KeyValue BC23_To_BC25
...
#Publish extensions
Publish-NAVApp -ServerInstance BC250 -Path "E:\Upgrade To BC 25 - GB\Core Apps\Microsoft_System Application.app"
Publish-NAVApp -ServerInstance BC250 -Path "E:\Upgrade To BC 25 - GB\Core Apps\Microsoft_Business Foundation.app"
Publish-NAVApp -ServerInstance BC250 -Path "E:\Upgrade To BC 25 - GB\Core Apps\Microsoft_Base Application.app"
Publish-NAVApp -ServerInstance BC250 -Path "E:\Upgrade To BC 25 - GB\Core Apps\Microsoft_Application.app"
...
Install-NAVApp -ServerInstance BC250 -Name "Business Foundation" -Version 25.1.25873.25900
...
#Run Data Upgrade
Start-NAVDataUpgrade -ServerInstance BC250 -Tenant default -FunctionExecutionMode Serial -SkipAppVersionCheck
Get-NAVDataUpgrade -ServerInstance BC250 -Progress
