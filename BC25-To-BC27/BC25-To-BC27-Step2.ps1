...
Invoke-NAVApplicationDatabaseConversion -DatabaseServer localhost -DatabaseName Upgrade-25-To-27-IN
...
Set-NAVServerConfiguration -ServerInstance BC270 -KeyName DatabaseName -KeyValue Upgrade-25-To-27-IN
